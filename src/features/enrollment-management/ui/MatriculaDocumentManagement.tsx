  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        console.error('Erro ao carregar documentos da matrÃ­cula:', err);
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card>
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Documentos da MatrÃ­cula</h1>
          </div>
          ...
          {!loading && !error && (
            <>
              {(!data || data.arquivos.length === 0) && (
                <p className="text-sm text-gray-500">Nenhum documento encontrado para esta matrÃ­cula.</p>
              )}
