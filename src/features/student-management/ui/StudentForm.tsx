...
import type { Polo, TipoDocumento, Nivel, Turma } from '@/shared/model/database';
import type { Aluno, Endereco } from '@/entities/student';
...
// Local interfaces removed in favor of @/entities/student types
...
const StudentForm: React.FC<StudentFormProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const studentData: any = {
      ...
      // Dados escolares
      escola_atual: formData.escola_origem,
      serie: formData.ano_escolar,
      foto: studentPhoto,
      ...
      // Saúde (Flat payload - No more 'saude' object)
