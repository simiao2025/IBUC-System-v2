...
const Module07: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-400 via-teal-400 to-cyan-600">
      {/* Header Section */}
      ...
      <div className="relative bg-gradient-to-r from-cyan-300 to-teal-400 py-16">
      ...
      <div className="bg-gradient-to-r from-cyan-500 to-teal-500 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Lessons Image */}
      ...
      {/* Back Button */}
      <div className="bg-gradient-to-r from-cyan-500 to-teal-500 py-8">
