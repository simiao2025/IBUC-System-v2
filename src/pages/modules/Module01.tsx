      ...
      <div className="relative bg-gradient-to-r from-blue-300 to-teal-400 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-between items-start mb-8">
            <h2 className="text-3xl font-bold text-gray-900">MÃ³dulo 01</h2>
          ...
          <div className="flex justify-center mb-8">
            <img
              ...
              alt="Livros do MÃ³dulo 01 - Entendendo a BÃ­blia"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-12">
            <img
              ...
              alt="LiÃ§Ãµes do MÃ³dulo 01 - Entendendo a BÃ­blia"
              className="max-w-4xl w-full h-auto rounded-lg shadow-2xl"
            />
          </div>
