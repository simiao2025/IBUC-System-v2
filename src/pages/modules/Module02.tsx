...
const Module02: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-400 via-emerald-400 to-green-600">
      {/* Header Section */}
      ...
      <div className="relative bg-gradient-to-r from-green-300 to-emerald-400 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Module Title */}
          <div className="flex justify-between items-start mb-8">
            <h2 className="text-3xl font-bold text-gray-900">MÃ³dulo 02</h2>
            <div className="text-9xl font-bold text-green-200 opacity-50">02</div>
          </div>

          {/* Books Image */}
          <div className="flex justify-center mb-8">
            <img
              src="https://ibuc.com.br/wp-content/uploads/2023/05/mod2_livros.jpg"
              alt="Livros do MÃ³dulo 02 - Crescendo na FÃ©"
      ...
      <div className="bg-gradient-to-r from-green-500 to-emerald-500 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-12">
            <img
              src="https://ibuc.com.br/wp-content/uploads/2023/05/mod2_licoes.jpg"
              alt="LiÃ§Ãµes do MÃ³dulo 02 - Crescendo na FÃ©"
              className="max-w-4xl w-full h-auto rounded-lg shadow-2xl"
            />
          </div>
